...
import com.example.alecontreras.datospersonalistalmacen.R;
...
public class Persona {
    ...
    private String tId, tNombre, tApellido, tEdad, tTelefono, tPermisoConducir, tNivelIngles, tFechaAlta;
    public Persona(){
        this.id = 0;
        this.nombre = "";
        this.apellido =  "";
