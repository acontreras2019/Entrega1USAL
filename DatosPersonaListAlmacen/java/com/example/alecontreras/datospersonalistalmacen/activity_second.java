...
public class activity_second extends AppCompatActivity {
    ...
    ArrayList<Integer> idEliminar = new ArrayList<Integer>() ;
    ...
    public void guardarLista(View view) {
        ...
        lista = new ListaPersonas(this);
        lista.lista = misPersonas;
        lista.GuardarLista(idEliminar);
    }
